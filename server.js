...
const files = {
  site: ensureDataFile("site.json", {
    ...
    companies: [
      ...
      { code: "AMZ", name: "Amazon", description: "Cloud, operations, coding assessments, and workplace readiness." },
      { code: "MS", name: "Microsoft", description: "Project portfolios, coding practice, cloud awareness, and interview preparation." },
      { code: "LT", name: "L&T", description: "Core engineering, site, design, and graduate trainee role guidance." },
      { code: "TEC", name: "Tech Mahindra", description: "Communication, programming, service delivery, and technical support readiness." }
    ]
  }),
  ...
  users: ensureDataFile("users.json", {
    ...
    teacher: [
      { id: "JGS-FAC-001", password: "teacher123", name: "Faculty User" },
      { id: "JGS-FAC-204", password: "teacher123", name: "Dr. Anitha Rao" },
      { id: "JGS-FAC-101", password: "teacher123", name: "Dr. Vivek Reddy" },
      { id: "JGS-FAC-118", password: "teacher123", name: "Prof. Neha Sharma" },
      { id: "JGS-FAC-126", password: "teacher123", name: "Mr. Karthik Menon" }
    ],
